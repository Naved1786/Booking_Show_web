  ...
  return (
    <div className='overflow-hidden w-[220px] h-[325px] border-4 hover:border-red-500 rounded-lg my-12 cursor-pointer '>
      ...
      <div className='absolute bottom-[45px] left-[40px]'>
        ...
        <button className='mt-4 w-20 h-8 bg-white text-xs hover:bg-red-500  hover:text-white font-bold transition duration-300 ease-in-out hover:scale-105' onClick={()=>navigate('/movieDetails')}>Get Ticket</button>
      </div>
    </div>
  )
}
