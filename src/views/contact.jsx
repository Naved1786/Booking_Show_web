    ...
    return (
        <div className='pt-20 flex flex-col justify-center items-center  bg-[url("./images/seat-bg.png")]'>
            <div className=' flex justify-center items-center flex-col w-[50%] h-[100vh]'>
                ...
                <button className='w-44 h-12 bg-red-500 text-xs mt-6 text-white font-bold border hover:bg-transparent hover:border-red-500 hover:text-red-500 transition duration-300 ease-in-out hover:scale-105 outline-none'>Send a Messege</button>
