...
const PaymentPage = () => {
  ...
  const handlePayment = () => {
    ...
    const options = {
      key: "rzp_test_pvDDPgmbWR8PkV", // Replace with your Razorpay key
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto bg-white flex flex-col md:flex-row  rounded-lg overflow-hidden">
          ...
          <div className="border-2 rounded-lg p-6 border-blue-500 bg-blue-50">
            <div className="flex items-center mb-4">
              <div className="h-12 w-12 bg-white rounded-lg shadow-md p-2 mr-4">
                <img src="/images/razorpay-logo.jpg" alt="Razorpay" className="h-full w-full scale-125" />
              </div>
              <div>
